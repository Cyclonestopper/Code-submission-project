#!/bin/bash
echo "Starting compilation of submissions/brilliant-music-821.cpp"
g++ -o "brilliant-music-821" "submissions/brilliant-music-821.cpp" 2> compile_errors.log
...
for input_file in test_cases/*.in; do
    ...
    ./brilliant-music-821 < "$input_file" > program_output.txt
...
rm "brilliant-music-821" program_output.txt compile_errors.log
