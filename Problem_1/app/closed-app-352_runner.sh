#!/bin/bash
echo "Starting compilation of submissions/closed-app-352.cpp"
g++ -o "closed-app-352" "submissions/closed-app-352.cpp" 2> compile_errors.log
if [ $? -ne 0 ]; then
...
for input_file in test_cases/*.in; do
    ...
    ./closed-app-352 < "$input_file" > program_output.txt
...
rm "closed-app-352" program_output.txt compile_errors.log
