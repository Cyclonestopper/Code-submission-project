#!/bin/bash
echo "Starting compilation of submissions/regular-cow-688 (2).cpp"
g++ -o "regular-cow-688 (2)" "submissions/regular-cow-688 (2).cpp" 2> compile_errors.log
if [ $? -ne 0 ]; then
...
for input_file in test_cases/*.in; do
    ...
    ./regular-cow-688 (2) < "$input_file" > program_output.txt
...
rm "regular-cow-688 (2)" program_output.txt compile_errors.log
