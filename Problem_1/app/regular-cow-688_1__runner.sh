#!/bin/bash
echo "Starting compilation of submissions/regular-cow-688_1_.cpp"
g++ -o "regular-cow-688_1_" "submissions/regular-cow-688_1_.cpp" 2> compile_errors.log
...
for input_file in test_cases/*.in; do
    ...
    ./regular-cow-688_1_ < "$input_file" > program_output.txt
...
rm "regular-cow-688_1_" program_output.txt compile_errors.log
