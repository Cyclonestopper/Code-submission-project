#!/bin/bash
echo "Starting compilation of submissions/regular-cow-688~.cpp"
g++ -I./bits -o "regular-cow-688~" "submissions/regular-cow-688~.cpp" 2> compile_errors.log
...
for input_file in test_cases/*.in; do
    ...
    ./regular-cow-688~ < "$input_file" > program_output.txt
...
rm "regular-cow-688~" program_output.txt compile_errors.log
