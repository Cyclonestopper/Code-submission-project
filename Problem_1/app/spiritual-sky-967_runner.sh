#!/bin/bash
echo "Starting compilation of submissions/spiritual-sky-967.cpp"
g++ -o "spiritual-sky-967" "submissions/spiritual-sky-967.cpp" 2> compile_errors.log
if [ $? -ne 0 ]; then
...
for input_file in test_cases/*.in; do
    ...
    ./spiritual-sky-967 < "$input_file" > program_output.txt
...
rm "spiritual-sky-967" program_output.txt compile_errors.log
