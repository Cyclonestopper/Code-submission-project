#!/bin/bash
echo "Starting compilation of submissions/regular-cow-688-2_.cpp"
g++ -o "regular-cow-688-2_" "submissions/regular-cow-688-2_.cpp" 2> compile_errors.log
if [ $? -ne 0 ]; then
...
for input_file in test_cases/*.in; do
    ...
    ./regular-cow-688-2_ < "$input_file" > program_output.txt
...
rm "regular-cow-688-2_" program_output.txt compile_errors.log
