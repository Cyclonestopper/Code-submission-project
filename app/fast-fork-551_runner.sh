#!/bin/bash
echo "Starting compilation of submissions/fast-fork-551.cpp"
g++ -I./bits -o "fast-fork-551" "submissions/fast-fork-551.cpp" 2> compile_errors.log
...
for input_file in test_cases/*.in; do
    ...
    ./fast-fork-551 < "$input_file" > program_output.txt
...
rm "fast-fork-551" program_output.txt compile_errors.log
