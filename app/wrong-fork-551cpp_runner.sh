#!/bin/bash
echo "Starting compilation of submissions/wrong-fork-551cpp.cpp"
g++ -o "wrong-fork-551cpp" "submissions/wrong-fork-551cpp.cpp" 2> compile_errors.log
...
for input_file in test_cases/*.in; do
    ...
    ./wrong-fork-551cpp < "$input_file" > program_output.txt
...
rm "wrong-fork-551cpp" program_output.txt compile_errors.log
